...
sudo rsync -avz ./Resourse/libaccounts-glib/* /home/koompi/.config/libaccounts-glib/
#move paper
sudo rsync -avz ./Resourse/Paper/* /usr/share/icons/Paper/
#move ttf-khmeros
sudo rsync -avz ./Resourse/ttf-khmeros/* /usr/share/fonts/truetype/ttf-khmeros/
cd ..
echo "Deleting file...."
rm -rf kosmosclup
